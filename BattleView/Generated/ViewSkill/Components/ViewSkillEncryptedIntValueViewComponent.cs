...
public partial class ViewSkillEntity {
    ...
    public Battle.View.Base.CSExtension.ViewComponent.EncryptedIntValueViewComponent encryptedIntValueView { get { return (Battle.View.Base.CSExtension.ViewComponent.EncryptedIntValueViewComponent)GetComponent(ViewSkillComponentsLookup.EncryptedIntValueView); } }
    ...
    public void AddEncryptedIntValueView(int newValue) {
        ...
        var component = (Battle.View.Base.CSExtension.ViewComponent.EncryptedIntValueViewComponent)CreateComponent(index, typeof(Battle.View.Base.CSExtension.ViewComponent.EncryptedIntValueViewComponent));
